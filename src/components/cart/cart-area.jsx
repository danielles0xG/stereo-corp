        ...
        <div className="container">
          {cartItems.length === 0 &&
            <div className='text-center'>
              ...
              <Link href={'/shop'}><a className="theme-btn mt-15">Return to shop</a></Link>
            </div>
          }
                  ...
                  <tbody>
                    {cartItems.map((item, i) => (
                      <tr key={i}>
                        ...
                        <td className="product-name"><Link href={`/shop-details/${item.id}`}>{item.title}</Link></td>
              ...
              <div className="row">
                <div className="col-md-5 ml-auto">
                  <div className="cart-page-total">
                    ...
                    <Link href="/checkout"><a className="theme-btn">Proceed to checkout</a></Link>
                  </div>
                </div>
              </div>
            </div>
